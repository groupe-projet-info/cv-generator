<template>
  <div id="container">
      ...
      <div>
        ...
        <ul class="no-style">
          <li class="sp-item">
            ...
            <span class="font-small">{number}</span>
          </li><br>
          <li class="sp-item">
            <svg width="1.25em" height="1.25em" viewBox="0 0 16 16" class="bi" xmlns="http://www.w3.org/2000/svg">
              <path fill="white" d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" />
            ...
            <span class="font-small">{mail}</span>
          </li><br>
          <li class="sp-item">
            <svg width="1.25em" height="1.25em" viewBox="0 0 16 16" class="bi" xmlns="http://www.w3.org/2000/svg">
              <path fill="white" d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" />
            ...
            <span class="font-small">{homeAdress}</span>
          </li><br>
          <li class="sp-item">
            <svg width="1.25em" height="1.25em" viewBox="0 0 16 16" class="bi" xmlns="http://www.w3.org/2000/svg">
              <path fill="white" d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" />
            ...
            <span class="font-small">{driversLicense}</span>
          </li>
        </ul>
      </div>
      <div>
        <h3>Langues</h3>
        <p class="no-margin">{languageName} ({languageLevel})</p>
      </div>
      <div>
        <h3>Informatique</h3>
        <ul class="no-style">
          <li class="sp-item">
            ...
            <span class="font-small">{Languages}</span>
          </li><br>
          <li class="sp-item">
            <svg width="1.25em" height="1.25em" viewBox="0 0 16 16" class="bi" xmlns="http://www.w3.org/2000/svg">
              <path fill="white" d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" />
          ...
          <li class="sp-item">
            ...
            <span class="font-small">{admin}</span>
          </li><br>
          <li class="sp-item">
            <svg width="1.25em" height="1.25em" viewBox="0 0 16 16" class="bi" xmlns="http://www.w3.org/2000/svg">
              <path fill="white" d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" />
            ...
            <span class="font-small">{Software}</span>
          </li>
        </ul>
      </div>
      <div>
        ...
        <div class="sp-item">
          <svg width="1.25em" height="1.25em" viewBox="0 0 16 16" class="bi" xmlns="http://www.w3.org/2000/svg">
            <path fill="white" d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" />
            <g transform-origin="center" transform="scale(0.8)" fill="#2B2D42">
    ...
    <div id="main-panel">
      ...
      <div class="main-item">
        <div class="item-header">
          <h2 class="no-margin">Expériences personnelles</h2>
        </div>
        <div class="item">
          <div class="item-date">{duration}</div>
          <div class="item-content no-margin no-padding c-lines">
